...
🚀🚀🚀 React-Admin-Vite，基于 React18、React-Router v6、React-Hooks、Redux && Redux-Toolkit、TypeScript、Vite2、Ant-Design 开源的一套后台管理框架。
...
```text
# GitHub
git clone https://github.com/jinloser/react-admin-vite.git
```
